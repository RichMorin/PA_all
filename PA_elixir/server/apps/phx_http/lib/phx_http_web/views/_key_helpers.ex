...
#     Generate a URL for an item.
  ...
  @spec get_precis(s) :: s when s: String.t
  ...
  @spec key_area(s) :: s when s: String.t
  ...
  @spec key_item(s) :: s when s: String.t
  ...
  @spec url_area(s) :: s when s: String.t
  ...
  @spec url_item(s) :: s when s: String.t
